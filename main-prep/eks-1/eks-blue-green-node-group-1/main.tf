...
resource "aws_eks_node_group" "green-nodes" {
  ...
  subnet_ids = [
    data.aws_subnet.public-subnet-01.id,   #data "aws_subnet" "public-subnet-02"
      data.aws_subnet.public-subnet-02.id 
      #data.aws_subnet.private_subnets_eks_ec2_01.id,
      #data.aws_subnet.private_subnets_eks_ec2_02.id 
    ]
